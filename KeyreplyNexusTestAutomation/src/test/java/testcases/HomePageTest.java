...
public class HomePageTest extends BaseClass {
	...
	@Test(priority = 3, description = "Verify dashboards cards", groups = { "homepage", "Regression" })
	public void verifyDashboardCards() {
		homePage = new HomePage(driver);

		homePage.verifyCardsArePresentInDahsboard();
